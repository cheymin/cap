...
function getClientIp(req) {
  ...
  if (headerName) {
    const ip = req.headers.get(headerName) || req.headers.get(headerName.toLowerCase());
    if (ip) {
  ...
  // Netlify serverless: 尝试从 x-nf-client-connection-ip 获取
